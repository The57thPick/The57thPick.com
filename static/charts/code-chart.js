...
const summary = '1817 / 1843 total Python files in the base project (Django) were correctly identified. In the random project (PokemonGo-Bot), 87 / 88 files were correctly identified.'
const ctx = document.getElementById('code-langs').getContext('2d')
